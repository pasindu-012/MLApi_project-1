...
st.info('Penguine data prediction')
app_mode = st.sidebar.selectbox('Select Page', ['Prediction', 'Explore'])
...
if app_mode == 'Prediction':
  ...
  with st.expander('Uplord images'):
  ...
  with st.expander('Results'):
    uploaded_image = type=["jpg", "jpeg", "png"]
    uploaded_audio = type=["mp4", "mov", "avi"]
    uploaded_video = type=["mp3", "wav"]
